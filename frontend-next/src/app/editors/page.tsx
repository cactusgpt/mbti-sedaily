...
const editors = [
  {
    ...
    personality: '감정?\n그건 변수에 안 넣습니다.',
    description: '시현은 뉴스를 읽을 때 감정을 철저히 배제해요. 원인과 결과, 데이터와 근거만으로 기사를 판단하죠. "왜 이 타이밍에 이 이슈가 터졌는가?"를 항상 먼저 생각하고, 기사 30개를 비교 분석한 뒤 논리적 정합성이 가장 높은 기사 하나를 골라요.',
  ...
  },
  {
    ...
    description: '지원은 뉴스에서 숫자가 아니라 사람을 봐요. 경제 기사를 읽어도 "이 뒤에 어떤 사람들이 있을까?" 생각하고, 읽다가 마음이 움직이면 한참을 멍하니 있기도 해요. 기사를 추천할 때도 조심스럽게, 진심을 담아서 나눠요.',
  ...
  },
  {
    ...
    description: '정훈은 군더더기를 싫어해요. 기사 30개를 훑되 3분 안에 끝냄. 실질적으로 도움 되는 기사 하나만 골라서 결론부터 전달하죠. "이거 하나만 읽으면 됨" — 그게 정훈 스타일이에요.',
  ...
  },
  {
    ...
    personality: '헐 여러분\n이거 꼭 봐야 해요!!!!',
    description: '하은은 혼자 기사 읽는 걸 못 참아요. 재밌는 기사 발견하면 바로 단톡방에 공유하고, "야 이거 봤어??" 하면서 친구한테 카톡을 보내죠. 기사를 추천하는 이유는 정보 전달이 아니라, 같이 신나고 싶어서!',
