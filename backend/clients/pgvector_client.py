...
class PgVectorClient:
    ...
    def __init__(
        ...
        self._database = database or os.getenv('PG_DATABASE', 'sedaily_mbti')
        self._user = user or os.getenv('PG_USER', 'postgres')
    ...
    def delete_article_vectors(self, news_id: str, mbti_group: Optional[str] = None) -> int:
        ...
        # pg8000.native doesn't expose rowcount directly; return -1 as sentinel
        return -1
